...
//  import {TrackComponent} from '../common/track'
import { TrackService } from '../../services/track/track.service';
//  import { Observable }     from 'rxjs/Observable';
//  import { Subject }    from 'rxjs/Subject';
import { Airport, xpLocation } from '../models/airport';
import { XpAirfieldCategory } from '../models/globals'
...
export class MapcontainerComponent implements OnInit {
  ...
  nearFields: Array<AgmMarker>;
  lines: Array<AgmPolyline>;
  hideSearchMessage: boolean;
  //intialPosition: AgmMarker;

  constructor( @Inject('iLocationService') private _trackService: iLocationService) {
    this.markers = new Array<AgmMarker>();
    this.nearFields = new Array<AgmMarker>();
    this.lines = new Array<AgmPolyline>();
    //this.geocoder = new google.maps.Geocoder();
    // this.address = "27 Croft Rd, Eleebana, NSW, Australia";
    // this.that = this;
    this.hideSearchMessage = true;
    // this.intialPosition = new AgmMarker()
  }
  ngOnInit() {
  }
  ...
  onFindClick(event) {
    ...
    //TXS get the bounds of the current map, then search for airports
    //var bounds = this.theMap.getBounds();
     var nthEast : xpLatLng = new xpLatLng(-31.0, 149.0);
     var sthWest : xpLatLng = new xpLatLng(-30, 148.0);
     this._trackService.getAirportsNearBy(sthWest, nthEast).subscribe(
  ...
  // accepts an array of airport objects, then creates markers on the map
  ...
  // Clear all markers and lines of the map
  onClearClick(event) {
...
//         this.theMap = new google.maps.Map(this.gmapElement.nativeElement, mapProp);
